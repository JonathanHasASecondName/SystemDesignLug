...
def Force_x_shear_calculation(thickness_1, diameter_1, width_1, F_x):
    V_x = F_x/4
...
#mass function
def calculate_mass(diameter_1,thickness_1,width_1,density,margin_1):
    volume = (((diameter_1*0.5+margin_1)*width_1) + ((np.pi*(width_1**2)*0.25)/2) - ((np.pi*(diameter_1**2)*0.25))) * thickness_1
    #radius = diameter_1/2
